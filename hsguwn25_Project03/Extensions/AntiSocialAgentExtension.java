/**
File: AntiSocialAgentExtension.java
Author: Hesed Guwn
Date: 09/27/2022
Project03
Course: CS231 B
...
public class AntiSocialAgentExtension extends AgentExtension
{
    ...
    public AntiSocialAgentExtension(double x0, double y0, int radius)
    {
        super( x0, y0 );
