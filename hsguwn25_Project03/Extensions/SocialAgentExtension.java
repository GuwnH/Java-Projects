/**
File: SocialAgentExtension.java
Author: Hesed Guwn
Date: 09/27/2022
Project03
Course: CS231 B
...
//Extension Changes in Line 50

import java.awt.Graphics;
import java.awt.Color;
import java.util.Random;

public class SocialAgentExtension extends AgentExtension
{
    ...
    public SocialAgentExtension(double x0, double y0, int radius)
    {
        super( x0, y0 );
    ...
    public void updateState(LandscapeExtension scape, int neighborTolerance){
