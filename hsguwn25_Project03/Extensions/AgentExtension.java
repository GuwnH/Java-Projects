...
public abstract class AgentExtension 
{
    ...
    public AgentExtension(double x0, double y0)
    {
        this.x = x0;
        this.y = y0;
    }   
    ...
    public abstract void updateState(LandscapeExtension scape, int neighborTolerance); 
