...
public class BlackJack {
    ...
    {
        //Checks the player hand value and runs while the cards are less than the ideal amount (16)
    ...
    public int game(boolean verbose)
    {
        ...
        if(dealerResult == false && playerResult == true)
        {
            if(verbose == true)
            {
                System.out.println("Final Hands: " + this.toString());   
    ...
    //Tests and runs the game
    public static void main(String[] args)
    {
        BlackJack aGame = new BlackJack(52);
